...
From https://github.com/tensorflow/adanet/blob/master/adanet/examples/tutorials/adanet_objective.ipynb


source ~/.bash_profile && python3 -m pip install adanet --upgrade

source ~/.bash_profile && python3 "/Users/carlos.aguilar/Google Drive/PythonSnippets/Tensorflow/adanet_tutorial.py"
