...
# Class imbalance (https://machinelearningmastery.com/xgboost-for-imbalanced-classification/)
'''
The implementation provides a hyperparameter designed to tune
 the behavior of the algorithm for imbalanced classification problems; 
...
'''
bst = xgb.train(param, dtrain, num_round, watchlist, scale_pos_weight=99)