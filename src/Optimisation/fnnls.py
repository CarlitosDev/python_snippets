...
'''
    Code from Michael Iovine
    
        Python implementation of the algorithm described in the paper 
        "A Fast Non-Negativity-Constrained Least Squares Algorithm" 
        by Rasmus Bro and Sumen De Jong.

    Downloaded from https://github.com/mikeiovine/fast-nnls

'''

'''
    There is also this other paper that claims to be faster:
    https://github.com/ProfMyre/tnt-nn/blob/master/src/tntnn.m
    https://www.sciencedirect.com/science/article/pii/S1877050917307858
'''
...
def fnnls(AtA, Aty, epsilon=None, iter_max=None):
    ...
    Code from Michael Iovine (https://github.com/mikeiovine/fast-nnls)
    """
    if epsilon is None:
